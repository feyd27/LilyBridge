/*
  ...
  - If NTP fails, publishes an error to "errors" topic
...
void loop() {
  ...
  // Temperature publishing every `intervalTempPublish`
  ...
  // Status publishing every `intervalStatusPublish`
  ...
  // FreeRTOS timers and callbacks handle reconnections
}
...
void WiFiEvent(WiFiEvent_t event) {
  ...
  switch (event) {
    ...
    case ARDUINO_EVENT_WIFI_STA_GOT_IP6:
      // Event ID 5: IPv6 obtained. Not a true disconnect—just log it.
