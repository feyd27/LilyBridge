...
export declare class Curve25519 {
    ...
    static readonly UNPACKED_SIZE: number;
    static readonly ORDER: number[];
    static readonly ORDER_TIMES_8: number[];
    static readonly BASE_2Y: number[];
    static readonly BASE_R2Y: number[];
    static readonly C1: number[];
    static readonly C9: number[];
    static readonly C486671: number[];
    static readonly C39420360: number[];
    static readonly P25: number;
    static readonly P26: number;
