...
* @category factories
*/
export declare const getAccountTransactionsFromSender: (service: ChainService) => (args: Omit<GetAccountTransactionsSenderRecipientArgs, "recipientId">) => Promise<TransactionList>;
