...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const uploadToSignumBtn = document.getElementById('uploadToSignumBtn');
        ...
        try {
            ...
            if (!res.ok) {
                ...
                try {
                    ...
                    if (res.status === 400 && err && err.error) {
                        msg = err.error;
                    }
                } catch (_) {
            ...
            smoothScrollToTop();
            showTimedAlert(`Upload successful! Transaction ID: ${json.blockId}`);
